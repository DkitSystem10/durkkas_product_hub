                        ...
                        <div className="space-y-3 flex-1">
                            {coreFeatures.map((feature, index) => (
                                <motion.button
                                    ...
                                    whileHover={{ x: 8 }}
                                    whileTap={{ scale: 0.96 }}
                                    className={`w-full text-left p-4 rounded-xl transition-all duration-300 group flex items-center gap-3 ${selectedFeature === index
                                            ? "bg-gradient-to-r from-emerald-500 to-blue-600 shadow-lg shadow-emerald-500/20"
                                            : "bg-slate-700/30 hover:bg-slate-700/60"
                                        }`}
                                >
                                    <div className={`flex-shrink-0 p-2 rounded-lg transition-all ${selectedFeature === index
                                            ? "bg-white/20"
                                                    ...
                                                    <div className="flex-1 flex items-end gap-2 md:gap-3">
                                                        {[60, 75, 45, 90, 70, 85].map((height, idx) => (
                                                            <motion.div
                                                                ...
                                                                className={`flex-1 rounded-t-md shadow-md cursor-pointer transition-all hover:shadow-lg ${idx % 2 === 0
                        ...
                        <div className="flex gap-3 min-w-max">
                            {coreFeatures.map((feature, index) => (
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className={`flex-shrink-0 px-4 py-3 rounded-lg whitespace-nowrap transition-all duration-300 flex items-center gap-2 text-sm font-bold ${selectedFeature === index
                                                        ...
                                                        <div className="flex items-end justify-between h-24 gap-1.5 bg-white/40 rounded-lg p-2">
                                                            {[60, 75, 45, 90, 70, 85].map((height, idx) => (
                                                                <motion.div
                                                                    ...
                                                                    className={`flex-1 rounded-t ${idx % 2 === 0
                                                                            ? "bg-gradient-to-t from-blue-500 to-blue-300"
                                                                            : "bg-gradient-to-t from-purple-500 to-purple-300"
                                        ...
                                        <div className="flex justify-center gap-2">
                                            {[1, 2, 3].map((dot) => (
                                                <motion.div
                                                    ...
                                                    className={`w-2 h-2 rounded-full ${dot <= index + 1
                                                            ? "bg-blue-600"
                                                            : "bg-blue-200"
                                                        } transition-colors`}
                                                />
                        ...
                        {[
                            ...
                            >
                                ...
                                <motion.div
                                    initial={{ scaleX: 0 }}
                                    whileHover={{ scaleX: 1 }}
                                    className={`h-1 rounded-full mt-2 origin-left ${idx === 0 ? "bg-blue-600" : idx === 1 ? "bg-purple-600" : "bg-indigo-600"
                                        }`}
                                />
                            </motion.div>
                        ))}
